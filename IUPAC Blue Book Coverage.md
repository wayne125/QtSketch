...
6. **P-9 stereochemistry completeness**: P-92.6 (pseudoasymmetric/Sequence Rule 5) and P-93.4's 2nd-shell E/Z tie-breaks are now done via Indigo's own CIP engine. Remaining: P-93.5/93.6 (substituent-branch and cyclic stereocenters), allenes.
...
8. Lower priority / rarely load-bearing for this app: P-26 (phane), P-27 (fullerenes), P-7/P-8 (ions/isotopes), P-10 (natural products).
